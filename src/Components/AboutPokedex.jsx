...
export default class AboutPokedex extends Component {
  render() {
    return (
      <div>
        <p>
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpo7wxoUjtiaJtci9SPqz1prgzZpU9n5M4Cg&usqp=CAU" alt="" />
      </div>
    )
  }
}